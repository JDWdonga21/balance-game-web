...
import result_key_08 from '../../assets/result_key_08.png'
import result_list_08_01 from '../../assets/result_list_08_01.png'
import result_list_08_02 from '../../assets/result_list_08_02.png'
import result_list_08_03 from '../../assets/result_list_08_03.png'
...
class Result8 extends React.Component {
                    ...
                    <div style={styles.wrap}>
                        <div style = {styles.result}>
                            ...
                            <div style={styles.resultItem}>
                                <div style={styles.keyTag}><img src={result_key_08} width="100%" alt="가성비 뚜벅이여행 숙소올인형"/></div>
                                <div style={styles.keylist}>
                                    <ul>
                                        <li style={styles.keyListLi}><a href="https://me2.do/Fm2F4Cft" target="_blank"><img src={result_list_08_01} width="100%" alt="힐링스테이코스모스리조트"/></a></li>
                                        <li style={styles.keyListLi}><a href="https://me2.do/IFIel1uJ" target="_blank"><img src={result_list_08_02} width="100%" alt="포트앤포트"/></a></li>
                                        <li style={styles.keyListLi}><a href="https://me2.do/5SaA3uXv" target="_blank"><img src={result_list_08_03} width="100%" alt="유리트리트"/></a></li>
                                    </ul>
                                </div>
                            </div>               
