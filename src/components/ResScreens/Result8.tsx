                        ...
                        <div style = {styles.result}>
                            ...
                            <div style={styles.resultItem}>
                                ...
                                <div style={styles.keylist}>
                                    <ul>
                                        <li><a href="https://me2.do/Fm2F4Cft" target="_blank"><img src={result_list_08_01} width="100%" alt="힐링스테이코스모스리조트"/></a></li>
                                        <li><a href="https://me2.do/IFIel1uJ" target="_blank"><img src={result_list_08_02} width="100%" alt="포트앤포트"/></a></li>
                                        <li><a href="https://me2.do/5SaA3uXv" target="_blank"><img src={result_list_08_03} width="100%" alt="유리트리트"/></a></li>
                                    </ul>
                                </div>
                            </div>               
